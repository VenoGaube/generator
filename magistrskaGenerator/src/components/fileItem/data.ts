export const COMPONENT_FILE_ITEM = [
    {
        'tag': 'fileItem',
        'value': 'Generating file item',
        'html':
`<p-card>
<div id="itemInfo">
  <a class="form-label" href="{{this.baseLink + nft.fileUrl}}" target="_blank">{{nft.title}}</a>
  <p class="form-label">Price: {{nft.price}}</p>
  ...
  <div class="row" style="padding-bottom: 12px">
    ...
    <div class="container-fluid container-fluid col-4">
